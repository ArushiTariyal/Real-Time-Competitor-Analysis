...
import sys
sys.path.append("C:\\Users\\arush\\AppData\\Roaming\\Python\\Python39\\Scripts")
import json
import time
...
for product_name, link in links.items():
    ...
    price.append(
        {
            "product_name": product_name,  # Use the variable directly
            "Price": product_data["selling price"],  # Correct key
